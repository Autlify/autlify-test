...
/**
 * @method GET /api/auth/token/confirm?token=xxx
 * @namespace AuthToken
 * @description Validate verification token from email link
 * @module IAM
 * @param token - The verification token from email
 * @returns Redirects to appropriate page based on token scope
 */
