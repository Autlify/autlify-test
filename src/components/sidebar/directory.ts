...
export const SIDEBAR_REGISTRY: SidebarOptionDef[] = [
  ...
  },
  {
    ...
    links: [
      {
        name: 'Customers',
        link: '/fi/accounts-receivable/customers',
        icon: 'person',
        feature: 'fi.accounts_receivable.subledgers',
        agency: true,
        subaccount: true,
        user: false,
        order: 10,
      }, 
      {
        ...
        link: '/fi/accounts-receivable/cash-application',
        icon: 'fileText',
        feature: 'fi.accounts_receivable.cash_application',
        agency: true,
        subaccount: true,
        user: false,
        order: 30,
      ...
      {
        name: 'Aging Report',
        link: '/fi/accounts-receivable/aging-report',
        icon: 'bar-chart-3',
        feature: 'fi.reporting.ar_ageing',
        agency: true,
        subaccount: true,
        user: false,
        order: 40,
  ...
  },
  {
    ...
    links: [
      {
        name: 'Vendors',
        link: '/fi/accounts-payable/vendors',
        icon: 'person',
        feature: 'fi.accounts_payable.subledgers',
        agency: true,
        subaccount: true,
        user: false,
        order: 10,
      ...
      {
        name: 'GR/IR Clearing',
        link: '/fi/accounts-payable/grir-clearing',
        icon: 'fileText',
        feature: 'fi.accounts_payable.grir_clearing',
        agency: true,
        subaccount: true,
        user: false,
        order: 30,
      },
      {
        ...
        link: '/fi/accounts-payable/payment-status',
        icon: 'bar-chart-3',
        feature: 'fi.reporting.ap_aging',
        agency: true,
        subaccount: true,
        user: false,
        order: 40,
