  ...
  function PaymentSuccessDialog(
    ...
    return (
      <Dialog open={openState} onOpenChange={setOpenState}>
        <DialogContent
          className={cn("w-[95%] sm:max-w-[560px] p-0 overflow-hidden rounded-lg border border-border/50 bg-surface-secondary shadow-lg", className)}
        >
          <div className="relative">
            <div className="p-7 flex flex-col items-center text-center gap-5">
              <div className="relative">
                <motion.div
                  className="absolute inset-0 -z-10 mx-auto size-20 rounded-full blur-xl bg-primary/20"
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 0.2 }}
                  transition={{ duration: 0.5, ease: "easeOut" }}
                />
                <div className="relative">
                  <div className="size-16 rounded-full bg-primary/10 flex items-center justify-center border border-primary/30 shadow-lg backdrop-blur-sm">
                  ...
                  {confetti.map((c) => (
                    <motion.span
                      ...
                      style={{
                        ...
                        width: c.size,
                        height: c.size * 0.6,
                        backgroundColor: colors[c.colorIndex],
                      }}
